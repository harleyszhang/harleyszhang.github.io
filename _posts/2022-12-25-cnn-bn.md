...
<div align="center">
<img src="../images/bn/normal-distribution-curve-1.png" width="60%" alt="正态分布概率密度函数曲线">
</div>
...
<div align="center">
<img src="../images/bn/normal_distribution_curve.png" width="60%" alt="不同参数的正态分布函数曲线">
</div>
...
<div align="center">
<img src="../images/bn/normal_distribution_curve2.png" width="60%" alt="自己实现的不同参数的正态分布函数曲线">
</div>
...
<div align="center">
<img src="../images/bn/bn_algorithm.png" width="60%" alt="Batch Normalizing Transform">
</div>
...
<div align="center">
<img src="../images/bn/algorithm2.png" width="60%" alt="Training a Batch-Normalized Network">
</div>

在训练期间，我们一次向网络提供一小批数据。在前向传播过程中，网络的每一层都处理该小批量数据。 `BN` 网络层按如下方式执行前向传播计算：

<div align="center">
<img src="../images/bn/bn_fp.png" width="60%" alt="Batch Norm 层执行的前向计算">
</div>
...
<div align="center">
<img src="../images/bn/bn_fp_shape.png" width="60%" alt="Batch Norm 向量的形状">
</div>
...
<div align="center">
<img src="../images/bn/Figure_4.png" width="60%" alt="实验结果表4">
</div>
...
<div align="center">
<img src="../images/activation_function/sigmoid_and_gradient_curve2.png" width="60%" alt="sigmoid 函数及其导数图像">
</div>
