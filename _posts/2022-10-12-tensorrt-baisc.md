...
summary: TensorRT 是 NVIDIA 官方推出的基于 CUDA 和 cudnn 的高性能深度学习推理加速引擎，能够使深度学习模型在 GPU 上进行低延迟、高吞吐量的部署。
...
<div align="center">
<img src="../images/TensorRT/tensorrt_workflow.jpg" width="60%" alt="TensorRT工作流程.jpg">
</div>
