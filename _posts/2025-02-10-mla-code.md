...
<div align="center">
<img src="../images/deepseekv2/transformers-mla-mermaid-diagram.jpg" width="70%" alt="transformers-mla-mermaid-diagram">
</div>
...
flowchart TD
  ...
  KVUp --> KNope["K NoPE (Content)<br/>(B, S, nH, d_nope)"]
  KVUp --> Val["Value (V)<br/>(B, S, nH, d_v)"]
  ...
  class SplitQ,SplitKVDown,QNope,KNope,Val,QRotRaw,KRotRaw splitNode;
