---
layout: post
title: MobileNetv1 论文详解
date: 2021-05-02 12:00:00
summary: MobileNet 论文的主要贡献在于提出了一种深度可分离卷积架构（DW+PW 卷积），先通过理论证明这种架构比常规的卷积计算成本（Mult-Adds）更小，然后通过分类、检测等多种实验证明模型的有效性。
categories: Backbone
---
...
<div align="center">
<img src="../images/mobilenetv1/standard_convolution_process.png" width="60%" alt="标准卷积过程">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/conv_gif.gif" width="60%" alt="卷积过程">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/conv3d.png" width="60%" alt="三通道经过两组过滤器的卷积过程">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/grouped_convolution.png" width="60%" alt="分组卷积">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/grouped_convolution_process_2.png" width="60%" alt="分组卷积过程2">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/dw_conv.png" width="60%" alt="DW卷积">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/Xception.png" width="60%" alt="Xeption">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/computational_steps_of_depthwise_separable_convolution.png" width="60%" alt="深度可分离卷积的计算步骤">
</div>

<div align="center">
<img src="../images/mobilenetv1/filter_size.png" width="60%" alt="滤波器尺寸">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/dw_convolution_calculation_steps.jpg" width="60%" alt="DW卷积计算步骤">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/pw_convolution_process.jpg" width="60%" alt="PW卷积过程">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/3x3_depth_separable_convolution_block_structure.png" width="60%" alt="3x3的深度可分离卷积Block结构">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/onnx_model_structure_diagram_of_depth_separable_convolution_block.png" width="60%" alt="深度可分离卷积block的onnx模型结构图">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/table_2.png" width="60%" alt="表2">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/table_1.png" width="60%" alt="表1">
</div>
...
<div align="center">
<img src="../images/mobilenetv1/convolution_behavior_differences_between_cpu_and_dsp.png" width="60%" alt="Convolution在CPU与DSP的行为差异">
</div>
