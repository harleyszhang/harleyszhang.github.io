---
layout: post
title: ssh 连接远程服务器方式总结
date: 2023-02-28 12:00:00
summary: SSH（安全外壳协议 Secure Shell Protocol，简称SSH）是一种加密的网络传输协议，用于在网络中实现客户端和服务端的连接，典型的如我们在本地电脑通过 SSH连接远程服务器，从而做开发，Windows、macOS、Linux都有自带的 SSH 客户端，但是在Windows上使用 SSH 客户端的体验并不是很好，所以我们一般使用 Xshell 来代替。
categories: Linux
---
