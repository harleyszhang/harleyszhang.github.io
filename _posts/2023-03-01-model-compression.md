...
- [一，模型压缩技术概述](#一模型压缩技术概述)
  - [1.1，模型压缩方法分类](#11模型压缩方法分类)
  - [1.2，模型压缩方法举例](#12模型压缩方法举例)
- [二，知识蒸馏](#二知识蒸馏)
- [三，轻量级模型架构](#三轻量级模型架构)
  - [3.1，如何设计高效CNN架构](#31如何设计高效cnn架构)
    - [一些结论](#一些结论)
    - [一些建议](#一些建议)
- [3.2，轻量级模型部署总结](#32轻量级模型部署总结)
- [四，模型剪枝](#四模型剪枝)
  - [4.1，结构化稀疏与非结构化剪枝比较](#41结构化稀疏与非结构化剪枝比较)
- [五，模型量化](#五模型量化)
  - [5.1，模型量化的方案](#51模型量化的方案)
  - [5.2，量化的分类](#52量化的分类)
- [六，压缩方法总结](#六压缩方法总结)
- [参考资料](#参考资料)
